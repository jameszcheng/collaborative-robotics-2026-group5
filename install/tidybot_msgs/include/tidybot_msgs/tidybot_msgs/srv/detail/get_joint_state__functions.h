...
#ifndef TIDYBOT_MSGS__SRV__DETAIL__GET_JOINT_STATE__FUNCTIONS_H_
#define TIDYBOT_MSGS__SRV__DETAIL__GET_JOINT_STATE__FUNCTIONS_H_
 ...
 * calls
 * tidybot_msgs__srv__GetJointState_Request__init().
...
/**
 * It calls
 * tidybot_msgs__srv__GetJointState_Request__fini()
 ...
 * tidybot_msgs__srv__GetJointState_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * tidybot_msgs__srv__GetJointState_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tidybot_msgs__srv__GetJointState_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tidybot_msgs
...
/**
 * It calls
 * tidybot_msgs__srv__GetJointState_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tidybot_msgs
...
/**
 * It allocates the memory for the array and calls
 * tidybot_msgs__srv__GetJointState_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tidybot_msgs
...
/**
 * It calls
 * tidybot_msgs__srv__GetJointState_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TIDYBOT_MSGS__SRV__DETAIL__GET_JOINT_STATE__FUNCTIONS_H_
