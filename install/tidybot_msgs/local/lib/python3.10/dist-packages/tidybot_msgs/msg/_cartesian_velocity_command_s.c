...
bool tidybot_msgs__msg__cartesian_velocity_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tidybot_msgs.msg._cartesian_velocity_command.CartesianVelocityCommand", full_classname_dest, 69) == 0);
  }
  tidybot_msgs__msg__CartesianVelocityCommand * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of CartesianVelocityCommand */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tidybot_msgs.msg._cartesian_velocity_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CartesianVelocityCommand");
