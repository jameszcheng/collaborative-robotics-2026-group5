...
bool tidybot_msgs__msg__arm_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tidybot_msgs.msg._arm_command.ArmCommand", full_classname_dest, 40) == 0);
  }
  tidybot_msgs__msg__ArmCommand * ros_message = _ros_message;
  {  // header
  ...
  {  // joint_positions
    ...
    }
    {
      ...
      Py_ssize_t size = 6;
      double * dest = ros_message->joint_positions;
...
PyObject * tidybot_msgs__msg__arm_command__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tidybot_msgs.msg._arm_command");
  ...
  {  // joint_positions
    ...
    double * src = &(ros_message->joint_positions[0]);
