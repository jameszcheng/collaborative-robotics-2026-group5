...
bool tidybot_msgs__srv__plan_to_target__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tidybot_msgs.srv._plan_to_target.PlanToTarget_Request", full_classname_dest, 53) == 0);
  }
  tidybot_msgs__srv__PlanToTarget_Request * ros_message = _ros_message;
  {  // arm_name
  ...
  {  // max_condition_number
    PyObject * field = PyObject_GetAttrString(_pymsg, "max_condition_number");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->max_condition_number = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PlanToTarget_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tidybot_msgs.srv._plan_to_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanToTarget_Request");
  ...
  {  // max_condition_number
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->max_condition_number);
    {
      int rc = PyObject_SetAttrString(_pymessage, "max_condition_number", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool tidybot_msgs__srv__plan_to_target__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tidybot_msgs.srv._plan_to_target.PlanToTarget_Response", full_classname_dest, 54) == 0);
  }
  tidybot_msgs__srv__PlanToTarget_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of PlanToTarget_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tidybot_msgs.srv._plan_to_target");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PlanToTarget_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
