...
#include "tidybot_msgs/msg/detail/gripper_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tidybot_msgs::msg::GripperCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tidybot_msgs::msg::GripperCommand & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tidybot_msgs::msg::GripperCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tidybot_msgs::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tidybot_msgs::msg::GripperCommand *>(
    untyped_ros_message);
...
{
  return &tidybot_msgs::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidybot_msgs, msg, GripperCommand)() {
  return &tidybot_msgs::msg::typesupport_fastrtps_cpp::_GripperCommand__handle;
}
