...
#include "tidybot_msgs/srv/detail/solve_ik__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tidybot_msgs::srv::SolveIK_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.seed_joint_positions;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tidybot_msgs::srv::SolveIK_Request & ros_message)
{
  // Member: arm_name
  cdr >> ros_message.arm_name;
  ...
  size_t current_alignment)
{
  ...
  // Member: seed_joint_positions
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.seed_joint_positions[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tidybot_msgs::srv::SolveIK_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tidybot_msgs::srv::SolveIK_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tidybot_msgs::srv::SolveIK_Request *>(
    untyped_ros_message);
...
{
  return &tidybot_msgs::srv::typesupport_fastrtps_cpp::_SolveIK_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidybot_msgs, srv, SolveIK_Request)() {
  return &tidybot_msgs::srv::typesupport_fastrtps_cpp::_SolveIK_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tidybot_msgs
cdr_serialize(
  const tidybot_msgs::srv::SolveIK_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tidybot_msgs::srv::SolveIK_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tidybot_msgs::srv::SolveIK_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tidybot_msgs::srv::SolveIK_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tidybot_msgs::srv::SolveIK_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &tidybot_msgs::srv::typesupport_fastrtps_cpp::_SolveIK_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidybot_msgs, srv, SolveIK_Response)() {
  return &tidybot_msgs::srv::typesupport_fastrtps_cpp::_SolveIK_Response__handle;
}
...
{
  return &tidybot_msgs::srv::typesupport_fastrtps_cpp::_SolveIK__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidybot_msgs, srv, SolveIK)() {
  return &tidybot_msgs::srv::typesupport_fastrtps_cpp::_SolveIK__handle;
}
