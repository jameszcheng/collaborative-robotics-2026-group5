...
static const _ArmVelocityCommand_type_support_symbol_names_t _ArmVelocityCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tidybot_msgs, msg, ArmVelocityCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tidybot_msgs, msg, ArmVelocityCommand)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tidybot_msgs, msg, ArmVelocityCommand)() {
  return &::tidybot_msgs::msg::rosidl_typesupport_c::ArmVelocityCommand_message_type_support_handle;
}
