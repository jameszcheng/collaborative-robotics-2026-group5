...
static const _PanTilt_type_support_symbol_names_t _PanTilt_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidybot_msgs, msg, PanTilt)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tidybot_msgs, msg, PanTilt)),
  }
};
...
{
  return &::tidybot_msgs::msg::rosidl_typesupport_cpp::PanTilt_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tidybot_msgs, msg, PanTilt)() {
  return get_message_type_support_handle<tidybot_msgs::msg::PanTilt>();
}
