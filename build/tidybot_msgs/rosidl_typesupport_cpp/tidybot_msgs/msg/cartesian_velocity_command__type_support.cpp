...
static const _CartesianVelocityCommand_type_support_symbol_names_t _CartesianVelocityCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tidybot_msgs, msg, CartesianVelocityCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tidybot_msgs, msg, CartesianVelocityCommand)),
  }
};
...
{
  return &::tidybot_msgs::msg::rosidl_typesupport_cpp::CartesianVelocityCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tidybot_msgs, msg, CartesianVelocityCommand)() {
  return get_message_type_support_handle<tidybot_msgs::msg::CartesianVelocityCommand>();
}
