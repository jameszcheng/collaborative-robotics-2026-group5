...
#include "tidybot_msgs/srv/detail/solve_ik__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // seed_joint_positions
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // seed_joint_positions
...
using _SolveIK_Request__ros_msg_type = tidybot_msgs__srv__SolveIK_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: seed_joint_positions
  {
    size_t size = ros_message->seed_joint_positions.size;
    auto array_ptr = ros_message->seed_joint_positions.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: seed_joint_positions
  {
    ...
    if (ros_message->seed_joint_positions.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->seed_joint_positions);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->seed_joint_positions, size)) {
      fprintf(stderr, "failed to create array for field 'seed_joint_positions'");
      return false;
    }
    auto array_ptr = ros_message->seed_joint_positions.data;
...
size_t get_serialized_size_tidybot_msgs__srv__SolveIK_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SolveIK_Request__ros_msg_type * ros_message = static_cast<const _SolveIK_Request__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name seed_joint_positions
  {
    size_t array_size = ros_message->seed_joint_positions.size;
    auto array_ptr = ros_message->seed_joint_positions.data;
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    (void)array_ptr;
...
static uint32_t _SolveIK_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tidybot_msgs__srv__SolveIK_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tidybot_msgs
size_t max_serialized_size_tidybot_msgs__srv__SolveIK_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tidybot_msgs__srv__SolveIK_Request;
    is_plain =
      (
...
static size_t _SolveIK_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tidybot_msgs__srv__SolveIK_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tidybot_msgs, srv, SolveIK_Request)() {
...
using _SolveIK_Response__ros_msg_type = tidybot_msgs__srv__SolveIK_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tidybot_msgs
size_t get_serialized_size_tidybot_msgs__srv__SolveIK_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SolveIK_Response__ros_msg_type * ros_message = static_cast<const _SolveIK_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tidybot_msgs__srv__SolveIK_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tidybot_msgs
size_t max_serialized_size_tidybot_msgs__srv__SolveIK_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tidybot_msgs__srv__SolveIK_Response;
    is_plain =
      (
...
static size_t _SolveIK_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tidybot_msgs__srv__SolveIK_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tidybot_msgs, srv, SolveIK_Response)() {
...
// already included above
// #include "tidybot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tidybot_msgs/srv/solve_ik.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tidybot_msgs, srv, SolveIK)() {
